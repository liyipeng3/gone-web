    ...
    <header
      ...
      <div
        ...
        <div
          ...
          <input
            className="border-b rounded-none border-solid border-gray-500 text-center h-8 pr-5 outline-0 w-full box-border bg-transparent text-gray-700 dark:text-white placeholder-gray-400 appearance-none outline-none"
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
                startSearch()
              }
